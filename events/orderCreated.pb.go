...
var file_orderCreated_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x22, 0x92, 0x01, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x44, 0x61,
	...
	0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x61, 0x73, 0x69, 0x6c, 0x6e, 0x73, 0x61, 0x67, 0x65,
	0x2f, 0x6d, 0x77, 0x6e, 0x2d, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x61, 0x70, 0x70, 0x2d, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_orderCreated_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_orderCreated_proto_goTypes = []interface{}{
	(*OrderCreated)(nil),          // 0: OrderCreated
	(*CreatedData)(nil),           // 1: CreatedData
	(subjects.Subject)(0),         // 2: Subject
	(Status)(0),                   // 3: Status
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_orderCreated_proto_depIdxs = []int32{
	2, // 0: OrderCreated.subject:type_name -> Subject
	1, // 1: OrderCreated.data:type_name -> CreatedData
	3, // 2: CreatedData.status:type_name -> Status
	4, // 3: CreatedData.expires_at:type_name -> google.protobuf.Timestamp
